...
var require_PresenceContext = __commonJS({
  "../../node_modules/@tamagui/use-presence/dist/cjs/PresenceContext.js"(exports, module2) {
    ...
    var PresenceContext2 = (0, import_react48.createContext)(null);
  }
});
...
var require_usePresence = __commonJS({
  "../../node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence2() {
      const context = (0, import_react48.useContext)(import_PresenceContext2.PresenceContext);
      if (!context) {
        return [true, null, context];
      }
      const { isPresent: isPresent22, onExitComplete, register } = context;
      const id = (0, import_react48.useId)() || "";
      (0, import_react48.useEffect)(() => register(id), [id, register]);
    ...
    function useIsPresent2() {
      return isPresent2((0, import_react48.useContext)(import_PresenceContext2.PresenceContext));
    }
...
var require_createAnimations = __commonJS({
  "../../node_modules/@tamagui/animations-react-native/dist/cjs/createAnimations.js"(exports, module2) {
    ...
    function useAnimatedNumber(initial) {
      const state = (0, import_web17.useSafeRef)(
        null
      );
      if (!state.current) {
        state.current = {
    ...
    function createAnimations2(animations2) {
      ...
      return {
        ...
        useAnimations: ({ props, onDidAnimate, style, state, presence }) => {
          ...
          const animateStyles = (0, import_web17.useSafeRef)({});
          const animatedTranforms = (0, import_web17.useSafeRef)([]);
          const animationsState = (0, import_web17.useSafeRef)(
            /* @__PURE__ */ new WeakMap()
          );
          const animateOnly = props.animateOnly || [];
          const args = [style, state, isExiting, !!onDidAnimate];
          const isThereNoNativeStyleKeys = (0, import_react48.useMemo)(() => {
          ...
          const res = (0, import_react48.useMemo)(() => {
            var _a;
            const runners = [];
            const completions = [];
            ...
            for (const key in style) {
              ...
              if (!val)
                continue;
              for (const [index4, transform] of val.entries()) {
                if (!transform)
                  continue;
                const tkey = Object.keys(transform)[0];
                const currentTransform = (_a = animatedTranforms.current[index4]) == null ? void 0 : _a[tkey];
                animatedTranforms.current[index4] = {
...
var require_useGet = __commonJS({
  "../../node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect15 = !isWeb28 || isClient7 ? import_react48.useLayoutEffect : import_react48.useEffect;
    function useGet6(currentValue, initialValue2, forwardToFunction) {
      const curRef = (0, import_react48.useRef)(initialValue2 ?? currentValue);
...
var require_FocusScope = __commonJS({
  "../../node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js"(exports, module2) {
    ...
    var import_compose_refs15 = require_cjs7();
...
var require_cjs10 = __commonJS({
  "../../node_modules/@tamagui/get-token/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown = /* @__PURE__ */ __name((type, current, options = defaultOptions) => {
      ...
      const found = tokensOrdered[index4];
...
var require_Image = __commonJS({
  "../../node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var Image2 = StyledImage.extractable(
      (0, import_react48.forwardRef)((inProps, ref) => {
...
var require_cjs15 = __commonJS({
  "../../node_modules/@tamagui/constants/dist/cjs/index.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect15 = isRSC4 ? idFn4 : isServer3 ? import_react48.useEffect : import_react48.useLayoutEffect;
...
var require_validStyleProps = __commonJS({
  "../../node_modules/@tamagui/helpers/dist/cjs/validStyleProps.js"(exports, module2) {
    ...
    var import_constants13 = require_cjs15();
  ...
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    var useGetThemedIcon4 = /* @__PURE__ */ __name((props) => {
      ...
      return (el) => {
        if (!el)
          return el;
        if ((0, import_react48.isValidElement)(el)) {
          return (0, import_react48.cloneElement)(el, {
            ...props,
            color: color2,
            // @ts-expect-error
            ...el.props
        ...
        return (0, import_react48.createElement)(el, props);
      };
    }, "useGetThemedIcon");
  }
});
...
var require_focusableInputHOC = __commonJS({
  "../../node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function useFocusable2({
      ...
      const inputValue = (0, import_react48.useRef)(value || defaultValue2 || "");
      const unregisterFocusable = (0, import_react48.useRef)();
      const inputRef = (0, import_react48.useCallback)(
        (input) => {
          var _a;
          if (!id)
            return;
...
var require_useControllableState = __commonJS({
  "../../node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const [state, setState] = (0, import_react48.useState)(prop ?? defaultProp);
      const previous = (0, import_react48.useRef)(state);
      ...
      const transitionFn = transition ? import_react48.startTransition : emptyCallbackFn2;
      (0, import_react48.useEffect)(() => {
        if (prop === void 0)
          return;
  ...
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState28 = React39.useState, useEffect30 = React39.useEffect, useLayoutEffect6 = React39.useLayoutEffect, useDebugValue2 = React39.useDebugValue;
  ...
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef29 = React39.useRef, useEffect30 = React39.useEffect, useMemo19 = React39.useMemo, useDebugValue2 = React39.useDebugValue;
        function useSyncExternalStoreWithSelector2(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
          ...
          var _useMemo = useMemo19(function() {
            var hasMemo = false;
...
var require_dist = __commonJS({
  "../../node_modules/reforest/dist/index.js"(exports, module2) {
    ...
    function parseIndexPath(indexPathString) {
      return indexPathString.split(".").map((index4) => parseInt(index4, 10));
    }
    ...
    function compareIndexPaths(a = "", b = "") {
      ...
      for (let index4 = 0; index4 < maxLength; index4++) {
        const difference = ((_a = aArray[index4]) != null ? _a : 0) - ((_b = bArray[index4]) != null ? _b : 0);
        if (difference === 0) {
          continue;
        }
    ...
    function useIndex() {
      ...
      return React39.useMemo(() => {
        ...
        const index4 = indexPath[indexPath.length - 1];
        return {
          maxIndex,
          maxIndexPath,
          index: index4,
          ...
          indexPathString,
          isFirst: index4 === 0,
          isLast: index4 === maxIndex,
          isEven: index4 % 2 === 0,
          isOdd: Math.abs(index4 % 2) === 1
        };
    ...
    function useIndexedChildren(children) {
      ...
      return /* @__PURE__ */ React39.createElement(MaxIndexContext.Provider, { value: maxIndexPath }, React39.Children.map(
        children,
        (child, index4) => React39.isValidElement(child) ? /* @__PURE__ */ React39.createElement(
...
var require_Group = __commonJS({
  "../../node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var import_jsx_runtime49 = require("react/jsx-runtime");
    var import_core54 = require("@tamagui/core-node");
    var import_create_context17 = require_cjs20();
    var import_stacks27 = require_cjs21();
    var import_use_controllable_state15 = require_cjs22();
    var import_react48 = __toESM2(require("react"));
    var import_react_native14 = require("react-native-web-lite");
    ...
    function createGroup(verticalDefault) {
      return (0, import_core54.withStaticProperties)(
        (0, import_react48.forwardRef)((props, ref) => {
          ...
          const childrenArray = import_react48.Children.toArray(childrenProp);
          ...
          const onItemMount = import_react48.default.useCallback(
            () => setItemChildrenCount((prev) => prev + 1),
            []
          );
          const onItemUnmount = import_react48.default.useCallback(
            () => setItemChildrenCount((prev) => prev - 1),
            []
          );
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      const groupItemProps = useGroupItem3(
        { disabled: (0, import_react48.isValidElement)(children) ? children.props.disabled : void 0 },
        __scopeGroup
      );
      ...
      if ((0, import_core54.isTamaguiElement)(children)) {
        return import_react48.default.cloneElement(children, groupItemProps);
      }
      return import_react48.default.cloneElement(children, {
        style: {
    ...
    var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
      ...
      return import_react48.default.cloneElement({ ...child, props: null }, next);
...
var require_wrapChildrenInText = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/wrapChildrenInText.js"(exports, module2) {
    ...
    function wrapChildrenInText2(TextComponent, propsIn, extraProps) {
      ...
      return import_react48.default.Children.toArray(children).map((child, index4) => {
        return typeof child === "string" ? /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(TextComponent, { ...props, ...textProps, children: child }, index4) : child;
      });
    }
...
var require_ListItem = __commonJS({
  "../../node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_jsx_runtime49 = require("react/jsx-runtime");
    var import_font_size4 = require_cjs14();
    var import_get_token12 = require_cjs10();
    var import_helpers_tamagui4 = require_cjs18();
    var import_stacks27 = require_cjs21();
    var import_text7 = require_cjs24();
    var import_web17 = require("@tamagui/core-node");
    var NAME3 = "ListItem";
    ...
    var ListItemFrame = (0, import_web17.styled)(import_stacks27.ThemeableStack, {
      name: NAME3,
      tag: "li",
    ...
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_web17.useProps)(props);
      ...
      const spaceSize = (0, import_web17.getVariableValue)((0, import_web17.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_web17.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime49.jsxs)(import_stacks27.YStack, { flex: 1, children: [
              noTextWrap === "all" ? title : /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(Title, { size: size3, children: title }),
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(import_jsx_runtime49.Fragment, { children: typeof subTitle === "string" && noTextWrap !== "all" ? (
                ...
                /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(Subtitle, { size: subtitleSize, children: subTitle })
              ) : subTitle }) : null,
              contents
            ] }) : contents,
...
var require_mutateTheme = __commonJS({
  "../../node_modules/@tamagui/theme/dist/cjs/_mutateTheme.js"(exports, module2) {
    ...
    function _mutateTheme(props) {
      ...
      const themeProxied = (0, import_web17.proxyThemeToParents)(themeName, theme, config2.themes);
      config2.themes[themeName] = themeProxied;
      let cssRules = [];
      (0, import_web17.updateConfig)("themes", { ...config2.themes, [themeName]: themeProxied });
      if (process.env.TAMAGUI_TARGET === "web") {
        if (insertCSS) {
          cssRules = (0, import_web17.getThemeCSSRules)({
...
var getValue = /* @__PURE__ */ __name((palette, value) => {
  ...
  const index4 = Math.min(Math.max(0, next), max3);
  return palette[index4];
}, "getValue");
...
var Adapt = (0, import_core2.withStaticProperties)(
  /* @__PURE__ */ __name(function Adapt2({ platform: platform2, when, children }) {
    const context = (0, import_react.useContext)(AdaptParentContext);
    const media2 = (0, import_core2.useMedia)();
...
function onlyElements(children) {
  const filtered = [];
  import_react6.Children.forEach(children, (child, index4) => {
...
var SheetImplementationCustom = (0, import_core12.themeable)(
  (0, import_react19.forwardRef)(/* @__PURE__ */ __name(function SheetImplementationCustom2(props, forwardedRef) {
    ...
    const animateTo = (0, import_core12.useEvent)((position2) => {
      if (frameSize === 0)
        return;
      let toValue = hasntMeasured || isHidden || position2 === -1 ? screenSize : positions[position2];
...
var ScrollView = (0, import_web4.styled)(import_react_native4.ScrollView, {
  name: "ScrollView",
  scrollEnabled: true,
  variants: {
    fullscreen: {
...
function wrapChildrenInText(TextComponent, propsIn, extraProps) {
  ...
  if (fontStyle)
    props.fontStyle = fontStyle;
  return import_react23.default.Children.toArray(children).map((child, index4) => {
    return typeof child === "string" ? (
      // so "data-disable-theme" is a hack to fix themeInverse, don't ask me why
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(TextComponent, { ...props, ...textProps, children: child }, index4)
    ) : child;
  });
}
...
var useSheetBreakpointActive = /* @__PURE__ */ __name((context) => {
  const media2 = (0, import_core17.useMedia)();
...
var import_helpers_tamagui = __toESM(require_cjs18());
...
function useButton(propsIn, { Text: Text5 = Button2.Text } = { Text: Button2.Text }) {
  ...
  const isNested = import_web10.isRSC ? false : (0, import_react24.useContext)(import_web10.ButtonNestingContext);
  ...
  const props = {
    ...
    tag,
    ...rest,
    children: import_web10.isRSC ? inner2 : /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_web10.ButtonNestingContext.Provider, { value: true, children: inner2 })
  };
  return {
    spaceSize,
    isNested,
...
// ../../node_modules/tamagui/dist/esm/index.js
__reExport(esm_exports2, __toESM(require_cjs14()));
...
var PopperAnchor = YStack.extractable(
  React17.forwardRef(/* @__PURE__ */ __name(function PopperAnchor2(props, forwardedRef) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(YStack, { ...getReferenceProps ? getReferenceProps(stackProps) : stackProps });
  }, "PopperAnchor2"))
);
...
var PopperContent = React17.forwardRef(
  /* @__PURE__ */ __name(function PopperContent2(props, forwardedRef) {
    ...
    const contentRefs = useComposedRefs(refs.floating, forwardedRef);
...
function useFloating3(options) {
  ...
  const [reference, _setReference] = React18.useState(null);
  const [floating, _setFloating] = React18.useState(null);
...
// ../../node_modules/@floating-ui/react/dist/floating-ui.react.esm.js
var index3 = typeof document !== "undefined" ? import_react31.useLayoutEffect : import_react31.useEffect;
...
function useLatestRef3(value) {
  const ref = (0, import_react31.useRef)(value);
  index3(() => {
    ref.current = value;
  });
  return ref;
...
var useHover = /* @__PURE__ */ __name(function(context, _temp) {
  ...
  const delayRef = useLatestRef3(delay);
...
function useFloating4(options) {
  ...
  const position = useFloating3(options);
  const tree = useFloatingTree();
...
var useFloatingContext = /* @__PURE__ */ __name(({ open, setOpen, breakpointActive }) => (0, import_react33.useCallback)(
  (props) => {
...
var PopoverContent = PopperContentFrame.extractable(
  React20.forwardRef(
    /* @__PURE__ */ __name(function PopoverContent2(props, forwardedRef) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(PopoverContentPortal, { zIndex: zIndex2, children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
        PopoverContentImpl,
        {
          ...contentImplProps,
          disableRemoveScroll,
...
function PopoverContentPortal(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Portal, { zIndex: zIndex2, children: /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(import_core25.Theme, { forceClassName: true, name: themeName, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(import_core25.Stack, { zIndex: zIndex2 + 1, children: contents })
  ] }) });
}
...
var useSheetBreakpointActive2 = /* @__PURE__ */ __name((breakpoint) => {
  const media2 = (0, import_core25.useMedia)();
...
var import_focusable3 = __toESM(require_cjs19());
...
var import_list_item = __toESM(require_cjs25());
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(FloatingOverlay, { style: { zIndex: zIndex2 }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_focus_scope3.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("div", { style: { display: "none" }, children: contents }) });
}, "SelectContent");
...
var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
  ...
  const { x, y, reference, floating, strategy, context, refs } = useFloating4({
    open,
    onOpenChange: setOpen,
...
var SelectScrollButtonImpl = React24.memo(
  React24.forwardRef(
    (props, forwardedRef) => {
      ...
      const { x, y, reference, floating, strategy, update, refs } = useFloating4({
        open: open && isVisible,
        strategy: "fixed",
    ...
    const content = function() {
      if (context.shouldRenderWebNative) {
        return (
          ...
          /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(NativeSelectFrame, { asChild: true, size: size3, value: context.value, children: /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
...
var useIsomorphicLayoutEffect13 = isRSC2 ? idFn2 : isServer ? import_react38.useEffect : import_react38.useLayoutEffect;
...
var SliderComponent = React29.forwardRef(
  (props, forwardedRef) => {
    const {
      name,
      min: min3 = 0,
...
var import_focusable4 = __toESM(require_cjs19());
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(
        SwitchProvider,
        {
          ...
          children: [
            ...
            import_core38.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
              BubbleInput3,
              {
                control: button,
                bubbles: !hasConsumerStoppedPropagationRef.current,
...
var import_group = __toESM(require_cjs23());
...
function createCollection(name) {
  ...
  const CollectionSlot = import_react39.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_core39.Slot, { ref: composedRefs, children });
    }
  );
  ...
  const CollectionItemSlot = import_react39.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_core39.Slot, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React33.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(import_web13.Theme, { name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
...
var import_focusable5 = __toESM(require_cjs19());
var import_font_size3 = __toESM(require_cjs14());
var import_get_token9 = __toESM(require_cjs10());
var import_group2 = __toESM(require_cjs23());
var import_helpers_tamagui3 = __toESM(require_cjs18());
...
var Toggle = ToggleFrame.extractable(
  React34.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(import_web14.Theme, { name: pressed ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      ToggleFrame,
      {
...
var ToggleGroupItem = ToggleFrame.extractable(
  import_react40.default.forwardRef(
    (props, forwardedRef) => {
      ...
      const childrens = import_react40.default.Children.toArray(props.children);
      const children = childrens.map((child) => {
        if (props.disablePassStyles || !import_react40.default.isValidElement(child)) {
          return child;
        }
        return getThemedIcon(child);
      });
      ...
      ) : /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(ToggleFrame, { asChild: true, focusable: !disabled, disabled, ref, children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef }) }) });
    }
  )
);
...
var ToggleGroup = (0, import_web15.withStaticProperties)(
  import_react40.default.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = import_react40.default.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue: defaultValue2,
    onValueChange = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      onItemDeactivate: import_react40.default.useCallback(
...
var ToggleGroupImplMultiple = import_react40.default.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue: defaultValue2,
    onValueChange = /* @__PURE__ */ __name(() => {
  ...
  const handleButtonActivate = import_react40.default.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = import_react40.default.useCallback(
...
var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(FloatingDelayGroup, { delay: React36.useMemo(() => delay, [JSON.stringify(delay)]), children });
}, "TooltipGroup");
var TooltipComponent = React36.forwardRef(/* @__PURE__ */ __name(function Tooltip(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(FloatingOverrideContext.Provider, { value: useFloatingContext2, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(Popper, { size: smallerSize.key, allowFlip: true, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
...
var TooltipSimple = /* @__PURE__ */ __name(({
  ...
  const contents = /* @__PURE__ */ (0, import_jsx_runtime42.jsxs)(Tooltip2, { ...tooltipProps, children: [
...
function useDebounce(fn, wait, options = defaultOpts, mountArgs = []) {
  const dbEffect = (0, import_react43.useRef)(null);
...
function useDebounceValue(val, amt = 0) {
  const [state, setState] = (0, import_react43.useState)(val);
  (0, import_react43.useEffect)(() => {
    const tm = setTimeout(() => {
      setState((prev) => {
        if (prev === val)
...
function useForceUpdate2() {
  return isServerSide ? idFn3 : (0, import_react44.useReducer)((x) => x + 1, 0)[1];
}
...
var TamaguiProvider = import_core43.isRSC ? import_core43.TamaguiProvider : ({ children, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(import_core43.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(PortalProvider, { shouldAddRootHost: true, children }) });
};
...
var Anchor = AnchorFrame.extractable(
  (0, import_react46.forwardRef)(({ href, target, ...props }, ref) => {
...
function Grid({ children, columns, itemMinWidth = 200, gap }) {
  ...
  const childrenList = import_react47.default.Children.toArray(children);
...
var import_focusable6 = __toESM(require_cjs19());
...
var TextArea = TextAreaFrame.styleable((propsIn, ref) => {
  const props = useInputProps(propsIn, ref);
  return /* @__PURE__ */ (0, import_jsx_runtime48.jsx)(TextAreaFrame, { ...props });
});
